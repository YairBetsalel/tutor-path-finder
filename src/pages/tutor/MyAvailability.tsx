...
export default function MyAvailabilityPage() {
  ...
  const { availability, isLoading: isLoadingAvailability, refetch } = useTutorAvailability(currentMonth);
                ...
                {daysInMonth.map((day) => {
                  ...
                  return (
                    <div
                      key={day.toISOString()}
                      className={cn(
                        "group relative min-h-[100px] rounded-lg border p-2 transition-colors",
                        isPast 
                    ...
                    >
                      ...
                      {!isPast && (
                        <AddAvailabilityDialog date={day} onSuccess={refetch} />
                      )}
